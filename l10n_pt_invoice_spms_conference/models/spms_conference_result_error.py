...
class SpmsConferenceResultError(models.Model):
    """One row per error reported by the conference document.
    ...
    _name = "spms.conference.result.error"
    _description = "SPMS Conference Result Error"
    ...
    level = fields.Selection(
        ...
        required=True,
        readonly=True,
        help="Nesting point of the conference document the error is " "anchored to.",
    )
    code = fields.Char(
        string="Error Code",
        index=True,
        readonly=True,
        help="Error code reported by the conference (Erro/Codigo), "
        "e.g. C010, C012, C313.",
    )
    ...
    amount_billed = fields.Monetary(
        ...
        readonly=True,
        help="Claim total as read by the conference, untaxed. Identical on "
    ...
    amount_allowed = fields.Monetary(
        ...
        readonly=True,
        help="Claim total recomputed by the conference, untaxed. Identical "
