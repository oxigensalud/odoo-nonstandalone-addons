...
from .test_spms_verification_transport import (
    TRANSPORT_PATH,
    _FakeTransport,
    _result_response,
)

# One wire-faithful journey: the answer envelope carries the verification
...
# verification document observed to date (105 errors on 96 claims, the 7
