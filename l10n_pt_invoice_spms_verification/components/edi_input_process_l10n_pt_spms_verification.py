...
class EdiInputProcessL10nPtSpmsVerification(Component):
    """Turn a fetched verification document into the invoice's verification result.
    ...
    _name = "edi.input.process.l10n_pt_spms.l10n_pt_spms_verification"
    _usage = "input.process"
    _backend_type = "l10n_pt_spms"
    _exchange_type = "l10n_pt_spms_verification"
    ...
    def process(self):
        ...
        verification_state = self._parse_verification_state(move, fact)
        problems = []
    ...
    def _store_result(self, move, result_vals, lines, errors):
        ...
        if result:
            ...
            result = self.env["spms.invoice.verification"].create(
