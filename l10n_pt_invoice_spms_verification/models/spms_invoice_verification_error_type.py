...
class SpmsInvoiceVerificationErrorType(models.Model):
    _name = "spms.invoice.verification.error.type"
    _description = "SPMS Invoice Verification Error Type"
    _order = "code"
    _rec_name = "code"
    ...
    description = fields.Char(
        ...
        readonly=True,
        help="Error message exactly as the CCF verification documents report it.",
    )
    ...
    def _get_or_create(self, code, message=None):
        ...
        publishes through the verification documents themselves, so the wire is
